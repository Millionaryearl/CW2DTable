...
// CW2DTable
#define COCOAPODS_POD_AVAILABLE_CW2DTable
#define COCOAPODS_VERSION_MAJOR_CW2DTable 0
#define COCOAPODS_VERSION_MINOR_CW2DTable 1
#define COCOAPODS_VERSION_PATCH_CW2DTable 0
